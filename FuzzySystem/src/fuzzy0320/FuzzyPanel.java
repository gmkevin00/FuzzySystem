...
public class FuzzyPanel extends JPanel {
	...
	public void moveCar(double turn){
		...
		System.out.printf("X:%f    Y:%f    R:%f    front:%f     R-L:%f    L:%f     R:%f\n",pointX,pointY,radious,this.countFrontLen(),countSideLen(),countLen(2),countLen(3));
	...
	public double countSideLen(){
		return this.countLen(3)-this.countLen(2);
	}
